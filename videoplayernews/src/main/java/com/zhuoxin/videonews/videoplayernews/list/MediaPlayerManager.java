package com.zhuoxin.videonews.videoplayernews.list;
 ...
 * 本类提供三对核心方法，给UI层调用
 * onResume、onPause和初始化和释放MediaPlayer（生命周期的保证）
 * startPlayer和stopPlayer，开始和停止视频播放（提供给视图层来出发业务）
 * addPlayerBackListener和removeAllListen
