package com.zhuoxin.videonews.videoplayernews.part;
...
import com.zhuoxin.videonews.videoplayernews.R;
 ...
 * 一个自定义的VideoView，使用MedioPlayer+SurfaceV来实现视频的播放
 * MediaPlayer来做视屏播放的控制，SurfaceView来显示视频
...
public class SimpleVideoPlayer extends FrameLayout {
    ...
    private void initSurfaceView() {
        ...
        //注意，vitamio使用suifaceView要设置fixelFormat,否则花屏
        ...
        btnToggle.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mediaPlayer.isPlaying()) {
                    ...
                    Toast.makeText(getContext(), "Can't paly now", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    //释放mediaplayer
    private void relerseMediaPlayer() {
        mediaPlayer.release();
        mediaPlayer = null;
        isPrepared = false;
